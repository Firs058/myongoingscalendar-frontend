...
const store = () => new Vuex.Store({
    ...
    mutations: {
        ...
        SET_SEARCH_LIST_PANEL: (state, bool) => state.search.list.panel = bool,
        SET_SEARCH_LIST_INPUT: (state, string) => state.search.list.input = string,
        SET_SEARCH_GLOBAL_PANEL: (state, bool) => state.search.global.panel = bool,
    ...
    actions: {
        ...
        setSearchListPanel: ({commit}, bool) => commit('SET_SEARCH_LIST_PANEL', bool),
        setSearchListInput: ({commit}, string) => commit('SET_SEARCH_LIST_INPUT', string),
        setSearchGlobalPanel: ({commit}, bool) => commit('SET_SEARCH_GLOBAL_PANEL', bool),
