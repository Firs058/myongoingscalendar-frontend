    ...
    export default {
        ...
        methods: {
            addLike() {
                ...
                this.$anime.api(`title/${this.comment.tid}/comments/${this.comment.id}/like/add`)
            ...
            addDislike() {
                ...
                this.$anime.api(`title/${this.comment.tid}/comments/${this.comment.id}/dislike/add`)
                    .then(result => this.$toast.showToast({code: result.data.status.code}))
                    .catch(code => this.$toast.showToast(code))
            ...
            addReport() {
                ...
                this.$anime.api(`title/${this.comment.tid}/comments/${this.comment.tid}/${this.comment.id}/report`)
                    .then(result => this.$toast.showToast({code: result.data.status.code}))
                    .catch(code => this.$toast.showToast(code))
